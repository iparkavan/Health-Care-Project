...
from settings import DATA_DUMP_THRESHOLD, MAX_RESULTS
...
class ICDMatcher:
    ...
    def __init__(self, data):
        ...
        self._key = None
        self._icd_desc = None
        self._max_match = DATA_DUMP_THRESHOLD
        self._key_list = []
    ...
    def get_icd_data_fuzz(self):
        ...
        if self._key_list:
            self._key_list = sorted(self._key_list, key=lambda d : d['Score'] , reverse= True)[:MAX_RESULTS]
